...
Version 0.4.6 (draft), January 2021 (work in progress, some parts are incomplete) by AnonymousPlanet.
...
**Trim is your ally and should always be enabled when using an SSD drive and should offer sufficient reasonable protection**. And this is also the reason you should not use Veracrypt Plausible deniability on a Trim enabled SSD as this feature is incompatible with Trim[^258].
...
Unfortunately Apple has removed the secure erase options from the trash bin even for HDD drives[^270]. So you're left with using other tools:
...
DuckDuckGo does not store cached version of pages[^271] and will instead forward you to a Google/Bing cached version if available.

In addition, DuckDuckGo source most of their searches from Bing (and not google)[^272] and therefore removing the content from Bing should in time have it removed it from DuckDuckGo too.
...
A commonly used technique which combines the idea of a Dead Drop[^273] and Secure Communication Obfuscation[^274] through Steganography[^275] and/or Kleptography[^276] and has many names such as Koalang[^277] or "Talking Around" or even "Social Steganography". This technique is very old and still widely used nowadays by teenagers to bypass parental control. It's hiding in plain sight.
...
As written earlier in this guide and as noted by Privacytools.io[^278], Windows 10 is a privacy nightmare. And disabling everything during and after the installation using the settings available to you is not enough. The amount of telemetry data collected by Microsoft is staggering and could defeat your attempts at keeping secrets. You will need to download and use a couple utilities to (hopefully) force Windows 10 into not sending data back to Microsoft.
...
-   The Windows USN journal which stores plenty of information[^280].

-   The Windows System Resource Usage Monitor (SRUM)[^281].

-   Various histories of various programs (such as the recent lists).

-   Various logs

-   The free (unallocated) space of your hard drive[^282].
...
There are several utilities that are recommend (like the old unmaintained DBAN[^283]) or System Rescue CD (<https://www.system-rescue.org/>) for this but personally, I will recommend the use of ShredOS.
...
**I do not recommend using external SSDs due to the uncertainty about their support for Trim, ATA Secure Erase and Sanitize options through USB 3.0 controllers. Instead I strongly recommend using external HDD 7300rpm USB3.0 disks which can be cleaned/wiped safely and securely without hassle.**
...
[^269]: UFSExplorer, Can I recover data from an encrypted storage? <https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php>

[^270]: EFF, How to: Delete Your Data Securely on macOS <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos>

[^271]: DuckDuckGo help, Cache <https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/>

[^272]: DuckDuckGo help, Sources <https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/>

[^273]: Wikipedia, Dead Drop <https://en.wikipedia.org/wiki/Dead_drop>

[^274]: Wikipedia, Secure Communication Obfuscation <https://en.wikipedia.org/wiki/Obfuscation#Secure_communication>

[^275]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography>

[^276]: Wikipedia, Kleptography <https://en.wikipedia.org/wiki/Kleptography>

[^277]: Wikipedia, Koalang <https://en.wikipedia.org/wiki/Koalang>

[^278]: Privacytools.io, Operating Systems <https://privacytools.io/operating-systems/>

[^279]: Brave Support, What is a Private Window with Tor? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor->

[^280]: Medium.com, The Windows USN Journal <https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e>

[^281]: Medium.com, Digging into the System Resource Usage Monitor (SRUM) <https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375>

[^282]: SANS, Timestamped Registry & NTFS Artifacts from Unallocated Space <https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/>

[^283]: DBAN, <https://dban.org/>
